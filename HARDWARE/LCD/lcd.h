...
/***********************************************************************************
	MY OWN SET OF FUNCTION ,ADAPTED TO MATRIXOS INTERFACE AND HAL INTERFACE.*/

void LCD_Network(u16 x1,u16 y1,u16 x2,u16 y2,u16 xwidth,u16 ywidth);
u16 LCD_y(u16 y);
...
void LCD_wave_show(u16 x1,u16 y1,u16 x2,u16 y2,float xrange0,
									 float xrange1,float yrange0,float yrange1,
									 float *posy,u16 data_num);
void LCD_cursor(u16 xpos,u16 ypos);
void LCD_erase(u16 x1,u16 y1,u16 x2,u16 y2);
void lcd_event(local_state_space *LCD_state);
