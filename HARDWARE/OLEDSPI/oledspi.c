...
{ 	
  ...
  /*Configure GPIO pins : PH9,10,11,12,13 */
  ...
  HAL_GPIO_WritePin(GPIOH,GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_13, GPIO_PIN_SET);
	///
